...
const getRankFromElo = (elo: number) => {
  ...
  return rank
    ? { key: rank[0], ...rank[1] }
    : { key: "plastic", ...rankedIcons.plastic };
};
...
const RaceLobby: React.FC<RaceLobbyProps> = ({
  ...
  */
  ...
  const raceType =
    "ranked" in gameData && (gameData as any).ranked ? "Ranked" : "Custom";

  // Get topic or text source
  const topic =
    gameData.textSource === "topic"
  ...
  const wordCount = gameData.text
    ? gameData.text.trim().split(/\s+/).length
    : 0;
    ...
    <div className="w-full max-w-7xl mx-auto p-4 mt-20 flex flex-col lg:flex-row gap-6 text-[#d1d0c5]">
      ...
      <div className="flex-1 bg-[#2c2e31] rounded-lg p-6 shadow-md">
        ...
        <p className="text-[#a1a1a1] mb-6">
          All players must ready up before the race can begin
        </p>
        ...
        <div className="space-y-4">
          ...
          {Array.from({
            length: Math.max(0, maxPlayers - sortedPlayers.length),
          }).map((_, index) => (
            <div
              key={`empty-${index}`}
              className="flex items-center justify-between"
            >
              ...
              <div className="px-4 py-1 rounded-full text-[#646669]">Empty</div>
            </div>
          ))}
        </div>
      ...
      <div className="w-full lg:w-96 space-y-6">
        ...
        <div className="bg-[#2c2e31] rounded-lg p-6 shadow-md">
          <h2 className="text-2xl font-bold mb-4 text-[#d1d0c5]">
            Invite Friends
          </h2>
          <p className="text-[#a1a1a1] mb-4">
            Share the code or link with your friends
          </p>
          ...
          <div className="mb-4">
            ...
            <div className="flex">
              ...
              >
                ...
                >
                  <path
                    d="M8 5H6C4.89543 5 4 5.89543 4 7V19C4 20.1046 4.89543 21 6 21H16C17.1046 21 18 20.1046 18 19V17M8 5C8 6.10457 8.89543 7 10 7H12C13.1046 7 14 6.10457 14 5M8 5C8 3.89543 8.89543 3 10 3H12C13.1046 3 14 3.89543 14 5M14 5H16C17.1046 5 18 5.89543 18 7V10M20 14H10M10 14L13 11M10 14L13 17"
                    stroke="currentColor"
                    strokeWidth="2"
                    strokeLinecap="round"
        ...
        <div className="bg-[#2c2e31] rounded-lg p-6 shadow-md">
          <h2 className="text-2xl font-bold mb-6 text-[#d1d0c5]">
            Game Settings
          </h2>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <p className="text-[#d1d0c5] font-medium">{raceType}</p>
            </div>

            <div className="flex justify-between items-center">
              <p className="text-[#d1d0c5]">Topic</p>
              <p className="text-[#d1d0c5] font-medium capitalize">{topic}</p>
            </div>

            <div className="flex justify-between items-center">
              <p className="text-[#d1d0c5]">Race Length</p>
              <p className="text-[#d1d0c5] font-medium">{raceLengthText}</p>
            </div>
          </div>
        </div>
      </div>
